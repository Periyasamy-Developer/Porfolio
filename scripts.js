...
document.addEventListener('DOMContentLoaded', () => {
  ...
  sb.reveal('.home .home-content, .skill-container .skills-box:nth-child(1), .service-container .services-box:nth-child(1), .contact-container .contact-section:nth-child(1), .timeline-items .timeline-item:nth-child(odd), .about-circle, .skills-section .skill:nth-child(odd), .personal-details ul li:nth-child(odd)', {origin: 'left'});
  sb.reveal('.home .home-img, .skill-container .skills-box:nth-child(2), .service-container .services-box:nth-child(2), .contact-container .contact-section:nth-child(2), .timeline-items .timeline-item:nth-child(even), .skills-section .skill:nth-child(even), .personal-details ul li:nth-child(even)', {origin: 'right'});
